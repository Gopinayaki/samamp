...
export class ReportComponent implements OnInit {
  ...
  constructor(private pageService: PagesService, private file: File, public modalController: ModalController ,public toastController: ToastController, private fileTransfer: FileTransfer
